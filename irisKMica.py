...
traindata = pd.read_csv("irisICA.csv", sep = ',', header = None, low_memory = False)
...
Y = traindata.values[1:,2]
traindata = traindata.values[1:, 0:2]
X = traindata
...
k = 2
# for k in range(2, 7):
clf = sklearn.cluster.KMeans(n_clusters= k, init='k-means++', n_init = 10, max_iter = 500)
